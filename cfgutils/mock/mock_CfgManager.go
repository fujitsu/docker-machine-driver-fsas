...
// PrepareNetworkConfig provides a mock function with given fields: lanports
func (_m *MockCfgManager) PrepareNetworkConfig(lanports []models.Lanport) (string, error) {
	ret := _m.Called(lanports)
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func([]models.Lanport) (string, error)); ok {
		return rf(lanports)
	}
	if rf, ok := ret.Get(0).(func([]models.Lanport) string); ok {
		r0 = rf(lanports)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func([]models.Lanport) error); ok {
		r1 = rf(lanports)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockCfgManager_Expecter) PrepareNetworkConfig(lanports interface{}) *MockCfgManager_PrepareNetworkConfig_Call {
	return &MockCfgManager_PrepareNetworkConfig_Call{Call: _e.mock.On("PrepareNetworkConfig", lanports)}
}

func (_c *MockCfgManager_PrepareNetworkConfig_Call) Run(run func(lanports []models.Lanport)) *MockCfgManager_PrepareNetworkConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]models.Lanport))
	})
	return _c
}
...
func (_c *MockCfgManager_PrepareNetworkConfig_Call) RunAndReturn(run func([]models.Lanport) (string, error)) *MockCfgManager_PrepareNetworkConfig_Call {
	_c.Call.Return(run)
	return _c
}
