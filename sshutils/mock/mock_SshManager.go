...
func (_e *MockSshManager_Expecter) IsReady() *MockSshManager_IsReady_Call {
	return &MockSshManager_IsReady_Call{Call: _e.mock.On("IsReady")}
}

func (_c *MockSshManager_IsReady_Call) Run(run func()) *MockSshManager_IsReady_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockSshManager_IsReady_Call) Return(_a0 bool) *MockSshManager_IsReady_Call {
	_c.Call.Return(_a0)
	return _c
}
