...
// SendStopCommand provides a mock function with no fields
func (_m *MockSshManager) SendStopCommand() error {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for SendStopCommand")
	}
...
// MockSshManager_SendStopCommand_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SendStopCommand'
type MockSshManager_SendStopCommand_Call struct {
	*mock.Call
}

// SendStopCommand is a helper method to define mock.On call
func (_e *MockSshManager_Expecter) SendStopCommand() *MockSshManager_SendStopCommand_Call {
	return &MockSshManager_SendStopCommand_Call{Call: _e.mock.On("SendStopCommand")}
}

func (_c *MockSshManager_SendStopCommand_Call) Run(run func()) *MockSshManager_SendStopCommand_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockSshManager_SendStopCommand_Call) Return(_a0 error) *MockSshManager_SendStopCommand_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSshManager_SendStopCommand_Call) RunAndReturn(run func() error) *MockSshManager_SendStopCommand_Call {
	_c.Call.Return(run)
	return _c
}
